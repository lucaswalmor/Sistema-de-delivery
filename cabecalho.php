...
<head>
    ...
    <!-- TAG DESCRIPTION SERVE PARA AJUDAR EM BUSCAS SEO -->
    <meta name="description" content="Lanches Uberaba">
    <meta name="author" content="Lucas Steinbach">
                    ...
                    <div class="rd-navbar-main-outer">
                        <div class="rd-navbar-main">
                            ...
                            <div class="rd-navbar-panel">
                                ...
                                <!-- RD Navbar Brand-->
                                <div class="rd-navbar-brand"><a class="brand" href="index.html"><img title="Ir para página inicial" src="images/logo-default-196x47.png" alt="" width="196" height="47" /></a></div>
                            </div>
                                ...
                                <div class="rd-navbar-nav-wrap">
                                    ...
                                    <div class="rd-navbar-basket-wrap">
                                        ...
                                        <div class="cart-inline">
                                            ...
                                            <span class="dados-usuarios"><p><a href="#" title="Editar Dados"><?php echo $_SESSION['nome_usuario'] ?></a><a href="logout.php" title="Desconectar"><img src="images/logout.png" width="30px" alt=""></a></p></span>
                                    ...
                                    <ul class="rd-navbar-nav">
                                        ...
                                        if (!isset($_SESSION['nome_usuario'])) {
                                            ...
                                            if($_SESSION['nivel_usuario'] == 'Cliente'){
                                                echo '<li class="rd-nav-item"><a class="rd-nav-link" target="_blank" href="painel-cliente">Meus Pedidos</a>
                                                </li>';
                                            }
                                            if($_SESSION['nivel_usuario'] == 'Cliente'){
                                                echo '<li class="rd-nav-item"><a class="rd-nav-link" target="_blank" href="painel-admin">Meus Pedidos</a>
                                                </li>';
                                            }
                                            if($_SESSION['nivel_usuario'] == 'Cliente'){
                                                echo '<li class="rd-nav-item"><a class="rd-nav-link" target="_blank" href="painel-balcao">Meus Pedidos</a>
                                                </li>';
                                            }
                                        }
                                        ?>
                                        ...
                                        <ul class="rd-navbar-modern-contacts">
                                            <li>
                                                <div class="unit unit-spacing-sm">
                                                    ...
                                                    <div class="unit-body"><a class="link-phone" href="https://api.whatsapp.com/send?phone=+5534992021394" target="_blank" title="Ir para whatsapp">34 992021394</a></div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="unit unit-spacing-sm">
                                                    <div class="unit-left"><span class="icon fa fa-location-arrow"></span></div>
                                                    <div class="unit-body"><a class="link-location" href="#">Uberaba-MG</a></div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="unit unit-spacing-sm">
                                                    <div class="unit-left"><span class="icon fa fa-envelope"></span></div>
                                                    <div class="unit-body"><a class="link-email" href="mailto:#">meuemail@teste.com</a></div>
                                                </div>
                                            </li>
                                        </ul>
                                        <ul class="list-inline rd-navbar-modern-list-social">
                                            <li><a class="icon fa fa-facebook" href="#" title="Ir para a pagina do facebook"></a></li>
                                            <li><a class="icon fa fa-twitter" href="#" title="Ir para a pagina do Twitter"></a></li>
                                            <li><a class="icon fa fa-instagram" href="#" title="Ir para a pagina do Instagram"></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
