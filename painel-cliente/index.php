...
if(@$_SESSION['nivel_usuario'] != 'Cliente'){
  echo "<script language='javascript'>windor.location='../login.php'</script>";
}
  ...
  <div class="wrapper">
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> Ultimo pedido - 10/04/2021</p>
                </div>
              </div>
              <!-- Message End -->
            </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Painel do Cliente</span>
      </a>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; <?= date('Y')?> <a href="https://github.com/lucaswalmor" target="_blank">Lucas Steinbach</a>.</strong>
      All rights reserved.
